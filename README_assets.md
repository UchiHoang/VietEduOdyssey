...
└── grades/                          # Assets theo TỪNG LỚP
    │
    ├── preschool/                   # 🧒 MẦM NON
    │   └── counting-animals/        # Game: Hành trình chú Cuội đến Cung Trăng
    │       ├── characters/
    │       │   ├── bunny_idle.png
    │       │   └── bear_happy.png
    │       ├── icons/
    ...
    │
    ├── grade1/                      # 📚 LỚP 1
    │   └── number-adventure/        # Game: Tí và cuộc đua cùng 12 con giáp
    │       ├── characters/
    │       │   ├── hero_idle.png
    │       │   └── guide_point.png
    │       ├── icons/
    ...
    │
    ├── grade3/                      # 📐 LỚP 3
    │   └── fraction-quest/          # Game: Sơn Tinh- Thủy Tinh
    │       ├── characters/
    │       │   ├── scientist_idle.png
    │       │   └── robot_calculate.png
    │       ├── icons/
    ...
    │
    ├── grade4/                      # 📏 LỚP 4
    │   └── geometry-world/          # Game: Thánh Gióng bay về trời
    │       ├── characters/
    │       │   ├── architect_idle.png
    │       │   └── architect_draw.png
    │       ├── icons/
    ...
    │
    └── grade5/                      # 🏆 LỚP 5
        └── math-champion/           # Game: Bảo vệ đất nước cùng Trạng Nguyên
            ├── characters/
            │   ├── champion_idle.png
