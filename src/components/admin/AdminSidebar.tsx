import { Users, BookOpen, BarChart3, Settings, LogOut, User, FolderOpen, MessageSquare, Video } from "lucide-react";
...
const AdminSidebar = ({ activeTab, onTabChange, profile, onLogout }: AdminSidebarProps) => {
  ...
  const menuItems = [
    ...
    { id: "lessons", label: t.adminSidebar.lessons, icon: Video },
